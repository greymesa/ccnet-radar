...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("movecraft")
    .setDescription(
      "Use this command to get a link for a specific Movecraft Ship page!"
    )
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName("cog").setDescription("A link to the Cog craft page!")
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("corvette")
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName("turret").setDescription("A link to the Turret page!")
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("zeppelin")
  ...
  async execute(interaction) {
    const aircraftcarrier = new MessageEmbed()
      ...
      .setDescription(
        italic("Use this link to learn about the Aircraft Carrier!")
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/AircraftCarrier](https://wiki.ccnetmc.com/en/Movecraft/Nations/AircraftCarrier)",
        inline: true,
      })
    ...
    const bomber = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Bomber](https://wiki.ccnetmc.com/en/Movecraft/Nations/Bomber)",
        inline: true,
      })
    ...
    const caravel = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Caravel](https://wiki.ccnetmc.com/en/Movecraft/Nations/Caravel)",
        inline: true,
      })
    ...
    const cargoship = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/CargoShip](https://wiki.ccnetmc.com/en/Movecraft/Nations/CargoShip)",
        inline: true,
      })
    ...
    const cog = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Cog](https://wiki.ccnetmc.com/en/Movecraft/Nations/Cog)",
        inline: true,
      })
    ...
    const corvette = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Corvette](https://wiki.ccnetmc.com/en/Movecraft/Nations/Corvette)",
        inline: true,
      })
    ...
    const cruiser = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Cruiser](https://wiki.ccnetmc.com/en/Movecraft/Nations/Cruiser)",
        inline: true,
      })
    ...
    const depthcharge = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/DepthCharge](https://wiki.ccnetmc.com/en/Movecraft/Nations/DepthCharge)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const destroyer = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Destroyer](https://wiki.ccnetmc.com/en/Movecraft/Nations/Destroyer)",
        inline: true,
      })
    ...
    const dreadnought = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Dreadnought](https://wiki.ccnetmc.com/en/Movecraft/Nations/Dreadnought)",
        inline: true,
      })
    ...
    const eastindiaman = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/EastIndiaman](https://wiki.ccnetmc.com/en/Movecraft/Nations/EastIndiaman)",
        inline: true,
      })
    ...
    const elevator = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Elevator](https://wiki.ccnetmc.com/en/Movecraft/Nations/Elevator)",
        inline: true,
      })
      .setImage(
        "https://wiki.ccnetmc.com/nations/ships/elevator-aircraft-carrier.png"
      )
      .setTimestamp()
      .setFooter({
        text: "Bot written by Shadowevil015",
    ...
    const fighter = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Fighter](https://wiki.ccnetmc.com/en/Movecraft/Nations/Fighter)",
        inline: true,
      })
    ...
    const heavytank = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/TankHeavy](https://wiki.ccnetmc.com/en/Movecraft/Nations/TankHeavy)",
        inline: true,
      })
    ...
    const icebreaker = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Icebreaker](https://wiki.ccnetmc.com/en/Movecraft/Nations/Icebreaker)",
        inline: true,
      })
    ...
    const ifv = new MessageEmbed()
      ...
      .setDescription(
        italic(
          "Use this link to learn about the (IFV) Infantry Fighting Vehicle!"
        )
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/IFV](https://wiki.ccnetmc.com/en/Movecraft/Nations/IFV)",
        inline: true,
      })
    ...
    const landingcraft = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/LandingCraft](https://wiki.ccnetmc.com/en/Movecraft/Nations/LandingCraft)",
        inline: true,
      })
    ...
    const shipyard = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Shipyard](https://wiki.ccnetmc.com/en/Movecraft/Nations/Shipyard)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const submarine = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Submarine](https://wiki.ccnetmc.com/en/Movecraft/Nations/Submarine)",
        inline: true,
      })
    ...
    const tank = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Tank](https://wiki.ccnetmc.com/en/Movecraft/Nations/Tank)",
        inline: true,
      })
    ...
    const torpedo = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Torpedo](https://wiki.ccnetmc.com/en/Movecraft/Nations/Torpedo)",
        inline: true,
      })
    ...
    const train = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Train](https://wiki.ccnetmc.com/en/Movecraft/Nations/Train)",
        inline: true,
      })
    ...
    const truck = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Truck](https://wiki.ccnetmc.com/en/Movecraft/Nations/Truck)",
        inline: true,
      })
    ...
    const turret = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Turret](https://wiki.ccnetmc.com/en/Movecraft/Nations/Turret)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const zeppelin = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Movecraft/Nations/Zeppelin](https://wiki.ccnetmc.com/en/Movecraft/Nations/Zeppelin)",
        inline: true,
      })
