...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("town")
    .setDescription(
      "Use this command, with a town name, to find information about it."
    )
  ...
  async execute(interaction) {
    ...
    var complttown = await fetch(
      "https://shadowevil015.tech/api/v1/towns/" + townname
    )
      .then((res) => res.json())
      .catch((err) => {
        return err;
    ...
    var colourFill = JSON.stringify(complttown.colourCodes.fill).replaceAll(
      /"/g,
      ""
    );
    ...
    const town = new MessageEmbed() // Create a message embed, called capital.
      ...
      .addFields(
        ...
        {
          name: "Location:",
          value: `[${coordinates}](${coordinatesLink})`.replaceAll(/"/g, ""),
          inline: true,
        }
      )
      .addFields(
      ...
      .addField(
        "Residents:",
        codeBlock(residents.replaceAll(/"/g, "").replaceAll(",", ", "))
      )
      .setTimestamp()
      .setFooter({
