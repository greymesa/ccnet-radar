...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription(
      "Use this command to see a list of online players on Nations!"
    ),

  async execute(interaction) {
    var onlinePlayers = await fetch(
      "https://shadowevil015.tech/api/v1/onlinePlayers/"
    )
      .then((res) => res.json())
      .catch((err) => {
        return err;
    ...
    var serverInfo = await fetch(
      "https://shadowevil015.tech/api/v1/serverInfo/"
    )
      .then((res) => res.json())
      .catch((err) => {
        return err;
