...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const nationsguide = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value: "[https://wiki.ccnetmc.com/Guides/nations-starter-guide](https://wiki.ccnetmc.com/Guides/nations-starter-guide)", inline: true })
      .setTimestamp()
    ...
    const townyguide = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Guides/towny-starter-guide](https://wiki.ccnetmc.com/en/Guides/towny-starter-guide)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437"});
    ...
    const runes = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Slimefun/Runes](https://wiki.ccnetmc.com/en/Slimefun/Runes)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437"});
    ...
    const brewery = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Brewery](https://wiki.ccnetmc.com/en/Brewery)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437" });
    ...
    const townyplugin = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Guides/TownyPlugin](https://wiki.ccnetmc.com/en/Guides/TownyPlugin)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437" });
    ...
    const siegewar = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Nations/WarSieging](https://wiki.ccnetmc.com/en/Nations/WarSieging)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437" });
    ...
    const combat = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Nations/WarCombat](https://wiki.ccnetmc.com/en/Nations/WarCombat)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437" });
    ...
    const navalsiege = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Nations/WarNavalSieges](https://wiki.ccnetmc.com/en/Nations/WarNavalSieges)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437"});
    ...
    const geofeatures = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Nations/Features](https://wiki.ccnetmc.com/en/Nations/Features)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437"});
    ...
    const voting = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value:"[https://wiki.ccnetmc.com/en/Voting](https://wiki.ccnetmc.com/en/Voting)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437"});
    ...
    const wikilink = new MessageEmbed()
      ...
      .addFields({ name: "Link:", value: "[https://wiki.ccnetmc.com/](https://wiki.ccnetmc.com/)", inline: true })
      .setTimestamp()
      .setFooter({text: "Bot written by Shadowevil015", iconURL:"https://minecraft-mp.com/images/favicon/204623.png?ts=1615034437"});
