...
module.exports = {
  ...
  async execute(interaction) {
    const nationsguide = new MessageEmbed()
      ...
      .setDescription(
        italic("Use this guide to learn about the Nations gamemode!")
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/Guides/nations-starter-guide](https://wiki.ccnetmc.com/Guides/nations-starter-guide)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const townyguide = new MessageEmbed()
      ...
      .setTitle(bold("Nations Starter Guide"))
      .setDescription(
        italic("Use this guide to learn about the Towny gamemode!")
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Guides/towny-starter-guide](https://wiki.ccnetmc.com/en/Guides/towny-starter-guide)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const runes = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Slimefun/Runes](https://wiki.ccnetmc.com/en/Slimefun/Runes)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const brewery = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Brewery](https://wiki.ccnetmc.com/en/Brewery)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const townyplugin = new MessageEmbed()
      ...
      .setDescription(
        italic(
          "Use this article to learn more about the Towny plugin, used on both Nations and Towny!"
        )
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Guides/TownyPlugin](https://wiki.ccnetmc.com/en/Guides/TownyPlugin)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const siegewar = new MessageEmbed()
      ...
      .setDescription(
        italic(
          "Use this article to learn more about Sieges on Nations, and how they work!"
        )
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Nations/WarSieging](https://wiki.ccnetmc.com/en/Nations/WarSieging)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const combat = new MessageEmbed()
      ...
      .setDescription(
        italic(
          "Use this article to learn more about Combat on Nations, and how it works!"
        )
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Nations/WarCombat](https://wiki.ccnetmc.com/en/Nations/WarCombat)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const navalsiege = new MessageEmbed()
      ...
      .setDescription(
        italic(
          "Use this article to learn more about the Naval Sieges around the Nations map!"
        )
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Nations/WarNavalSieges](https://wiki.ccnetmc.com/en/Nations/WarNavalSieges)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const geofeatures = new MessageEmbed()
      ...
      .setDescription(
        italic(
          "Use this article to learn more about the Geopolitical Features on Nations!"
        )
      )
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Nations/Features](https://wiki.ccnetmc.com/en/Nations/Features)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const voting = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value:
          "[https://wiki.ccnetmc.com/en/Voting](https://wiki.ccnetmc.com/en/Voting)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
    ...
    const wikilink = new MessageEmbed()
      ...
      .addFields({
        name: "Link:",
        value: "[https://wiki.ccnetmc.com/](https://wiki.ccnetmc.com/)",
        inline: true,
      })
      .setTimestamp()
      .setFooter({
